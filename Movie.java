...
public class Movie {
	...
	//attributes/ fields are the same as variables
	
	//private is hidden from the shit information hiding
	...
	public  Movie ()
	{
		//attributes of field of the class
	...
	public Movie(String title, String rating, int soldTickets) {
		...
		//why the title colors are different because the light blue is attributes
		
		//the dark blue is just the title;
